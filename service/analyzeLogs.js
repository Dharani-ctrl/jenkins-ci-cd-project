...
if (!logs) {
  if (fs.existsSync(LOG_FILE_PATH)) {
    ...
    console.log(" No log file found, analyzing default success log.");
  }
}
...
const analyzeLogs = async () => {
  ...
  if (!apiKey) {
    console.log(" No GEMINI_API_KEY found in environment. Skipping AI Log Analysis.");
  ...
  try {
    ...
    try {
      ...
      console.log(" Failed to parse AI response as JSON:", aiText);
      return;
    }
